...
, internal var buttonWidth:Int):ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT) {
    ...
    private lateinit var removeverQueue:Queue<Int>
    ...
    private val onTouchListener= View.OnTouchListener { _, motionEvent ->
        ...
        if (motionEvent.action== MotionEvent.ACTION_DOWN ||
            ...
            if (rect.top < point.y && rect.bottom > point.y)
                ...
                removeverQueue!!.add(swipePosition)
                swipePosition= -1
                recoverSwipedItem()
            }
        }
    ...
    init {
        ...
        removeverQueue = object :LinkedList<Int>(){
    ...
    private fun recoverSwipedItem(){
        while (!removeverQueue.isEmpty()){
            val pos = removeverQueue.poll()!!
            if (pos > -1)
