...
import com.pbmt.s_note.databases.NoteDatabase
import com.pbmt.s_note.entities.Notes
import com.pbmt.s_note.util.NoteBottomSheetFragment
            ...
            if (data != null){
                ...
                if (selectedImageUrl != null){
                    ...
                    try {
                        ...
                        var inputStream = requireActivity().contentResolver.openInputStream(
                            selectedImageUrl
                        )
